...
//            text,image丶radio、vedio
    ...
    public void execute(ShardingContext shardingContext) {
        //获取分页参数 String jobParameter = shardingContext.getShardingParameter();
        //再通过jobParameter去数据库查询数据来赋值给files(这就可以防止分布式任务调度重复问题)
        //==============================================================
        //作业分片信息
...
//        System.out.println(String.format("%sTime:%s,已获取%d文件", "现在的",
//                "hahahahaha",2));          现在的Time:hahahahaha,已获取2文件
        return fetchList;
    }
